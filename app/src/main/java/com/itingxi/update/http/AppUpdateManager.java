...
import com.itingxi.update.utils.ApkUtils;
import com.itingxi.update.utils.FileUtils;
import com.itingxi.update.utils.ToastUtils;
import com.itingxi.update.utils.Utils;
import com.itingxi.AboutActivity;
    ...
    public void handleDownloadResult(Message msg) {
        ...
        switch (downloadResult) {
            case FLAG_CANCEL_UPDATE: // 取消下载
                ...
                showNotification("取消下载", "已取消下载", new Intent(mContext, AboutActivity.class));
                break;
            case FLAG_DOWNLOAD_ERROR: // 下载错误
                ToastUtils.showShort(mContext, R.string.tip_update_error);
                showNotification("更新出错", "更新出错，请稍后再试", new Intent(mContext, AboutActivity.class));

                break;
            case FLAG_NO_ENOUGH_SPACE: // 空间不足
                ToastUtils.showShort(mContext, R.string.tip_no_enough_space);
                showNotification("下载出错，", "存储空间不足", new Intent(mContext, AboutActivity.class));
